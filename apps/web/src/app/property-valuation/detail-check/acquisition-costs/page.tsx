...
function AcquisitionCostsContent() {
  ...
  return (
    <PropertyValuationLayout currentStep={1}>
      <div className="pb-24">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-foreground">Kaufkosten</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Bekannte Werte aus der Ersteinschätzung werden vorbefüllt. Graue Felder werden automatisch berechnet.
          </p>
        </div>
